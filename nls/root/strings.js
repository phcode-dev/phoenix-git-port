...
define({
    ...
    CHECKOUT_COMMIT_DETAIL:             "{0} <br><br>Commit hash: {1}",
    BUTTON_CLONE:                       "Clone",
    BUTTON_CLOSE:                       "Close",
    ...
    MENU_RESET_MIXED:                   "Discard commits but keep changes unstaged (mixed reset)",
    MENU_RESET_SOFT:                    "Discard commits but keep changes staged (soft reset)",
    RESET_HARD_TITLE:                   "Confirm Hard Reset",
    RESET_MIXED_TITLE:                  "Confirm Mixed Reset",
    RESET_SOFT_TITLE:                   "Confirm Soft Reset",
    RESET_DETAIL:                       "<b>Commits after the following will be discarded:</b><br>Commit Message: {0}<br><b>Git Command:</b> {1}",
